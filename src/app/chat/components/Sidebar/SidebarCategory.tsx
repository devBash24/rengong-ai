  ...
  return (
    <div className="mb-4">
      ...
      <div
        ...
        className="flex justify-between items-center px-4 py-2 cursor-pointer bg-[#3393FF] hover:bg-opacity-80 rounded-md"
      >
        <h3 className="font-semibold text-white">{title}</h3>
        <button className="text-gray-500 hover:text-gray-700">
          {isCollapsed ? <IoChevronDown className={iconStyle} /> : <IoChevronUp className={iconStyle} />}
        </button>
      </div>
